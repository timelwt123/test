...
<div id="apDiv3"><img src="arrow-right-circle-fill.svg">
  <div id="apDiv4"><form name="fmso" action="so.do" method="post">
    <button type="submit" class="btn btn-primary btn-lg">点击进入销售界面</button>
    </form></div>
</div>
<div id="apDiv2">
