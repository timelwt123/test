...
<div id="apDiv2" align="center">
  <table width="470" height="354" border="0" cellpadding="0" cellspacing="0">
    <tr class="font-weight-bold">
      <td width="115"  align="center" valign="middle">书名：</td>
      <td width="326">${bookname }</td>
    </tr>
    <tr class="font-weight-bold">
      <td align="center" valign="middle">进货数量：</td>
      <td>${jhnum }</td>
    </tr>
    <tr class="font-weight-bold">
    ...
    <tr>
    <td><form name="jhdform" action="jhd.do" method="post">
<button type="submit" class="btn btn-outline-success">查看进货表</button>
</form><td>
